...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 10.38;

        FollowerConstants.xMovement = 54.7785; //233.0658; //60.9888;
        FollowerConstants.yMovement = 36.2188; //68.4715; //36.8524;

        FollowerConstants.forwardZeroPowerAcceleration = -26.3415; //-206.637; //-1658.0034;//-28.2039;// // //-645.3369 //-1658.0034
        FollowerConstants.lateralZeroPowerAcceleration = -67.1619; //-639.9137; //-2453.2616;//-75.0264;

        FollowerConstants.translationalPIDFCoefficients = new CustomPIDFCoefficients(0.3,0,0.02,0);//(0.1,0,0.01,0);
        ...
        FollowerConstants.headingPIDFCoefficients = new CustomPIDFCoefficients(2,0,0.3,0);
        ...
        FollowerConstants.drivePIDFCoefficients = new CustomFilteredPIDFCoefficients(0.005,0,0.0000001,0.6,0);
